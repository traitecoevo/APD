...
params:
  traits_selected: "leaf_photosynthetic_rate_per_area_maximum"
format:
   pdf:
    toc: false
    papersize: A4
...
exact_match <- trait_i %>%
  ...
  mutate(
    exact_TOP_verbal = ifelse(!is.na(exact_TOP_verbal),paste0("[TOP](https://top-thesaurus.org/index): ", TOP$label[match(trait_i$exact_TOP_verbal, TOP$traitID)]," [", trait_i$exact_TOP_verbal,"]"),NA),
...
close_match <- trait_i %>%
  ...
  mutate(
    close_TOP_verbal = ifelse(!is.na(close_TOP_verbal),paste0("[TOP](http://top-thesaurus.org/): ",TOP$label[match(trait_i$close_TOP_verbal, TOP$traitID)]," [", trait_i$close_TOP_verbal,"]"),NA),
