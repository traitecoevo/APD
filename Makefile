...
clean:  ## Delete the generated artefacts, the rendered site and the Quarto cache
	rm -rf export docs .quarto
	@echo "Left release/ alone -- the versioned snapshots are tracked in git."
