...
APD_traits <- read_csv("https://github.com/traitecoevo/APD/blob/master/APD_traits.csv", show_col_types = FALSE)
APD_categorical_values <- read_csv("https://github.com/traitecoevo/APD/blob/master/APD_categorical_values.csv", show_col_types = FALSE)
