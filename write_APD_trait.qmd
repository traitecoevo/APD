...
**[trait type](http://terminologies.gfbio.org/terms/ETS/valueType)**: [`r classes$label[match(trait_i$type, classes$identifier_to_match)]`](`r classes$Entity[match(trait_i$type, classes$identifier_to_match)]`)   
...
plant_structure <- trait_i %>%
  ...
  select(-name) %>%
  mutate(
    term = classes$label[match(value, classes$identifier_to_match)],
    url = classes$Entity[match(value, classes$identifier_to_match)],
...
exact_match <- trait_i %>%
  ...
  mutate(
    exact_other1 = ifelse(!is.na(exact_other1), paste0("[",classes$identifier[match(trait_i$exact_other1, classes$identifier_to_match)],"](", classes$Entity[match(trait_i$exact_other1, classes$identifier_to_match)], "): ", classes$label[match(trait_i$exact_other1, classes$identifier_to_match)]), NA),
...
close_match <- trait_i %>%
  ...
  mutate(
    close_other1 = ifelse(!is.na(close_other1), paste0("[",classes$identifier[match(trait_i$close_other1, classes$identifier_to_match)],"](", classes$Entity[match(trait_i$close_other1, classes$identifier_to_match)], "): ", classes$label[match(trait_i$close_other1, classes$identifier_to_match)]), NA),
    close_other2 = ifelse(!is.na(close_other2), paste0("[",classes$identifier[match(trait_i$close_other2, classes$identifier_to_match)],"](", classes$Entity[match(trait_i$close_other2, classes$identifier_to_match)], "): ", classes$label[match(trait_i$close_other2, classes$identifier_to_match)]), NA),
...
related_match <- trait_i %>%
  ...
  mutate(
    related_other = ifelse(!is.na(related_other), paste0("[",classes$identifier[match(trait_i$related_other, classes$identifier_to_match)],"](", classes$Entity[match(trait_i$related_other, classes$identifier_to_match)], "): ", classes$label[match(trait_i$related_other, classes$identifier_to_match)]), NA),
