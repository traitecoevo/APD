...
```
**Latest version**: https://www.w3id.org/APD/APD.html
**This version**: https://www.w3id.org/APD/2023-05-1/APD.html
**Previous version**: https://www.w3id.org/APD/2023-02-1/APD.html
...
The following table gives an overview of the APD voabulary. This document includes the folliwng sections
...
for (thistrait in traits) {
  ...
  out <- 
    create_APD_trait_table(thistrait, APD, categorical_values)
